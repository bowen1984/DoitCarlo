    ...
    else
        {
            return (
                ...
                <Descriptions title="Progetto">
                    ...
                    <Descriptions.Item label="Data Pubblicazione">{data.dataPubblicazione}</Descriptions.Item>
                    <Descriptions.Item label="Data Scadenza">{data.dataScadenza}</Descriptions.Item>
